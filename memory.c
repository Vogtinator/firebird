...
u32 FASTCALL mmio_read_byte(u32 addr) {
	return read_byte_map[addr >> 26](addr);
}
u32 FASTCALL mmio_read_half(u32 addr) {
	return read_half_map[addr >> 26](addr);
}
u32 FASTCALL mmio_read_word(u32 addr) {
	return read_word_map[addr >> 26](addr);
}
void FASTCALL mmio_write_byte(u32 addr, u32 value) {
	write_byte_map[addr >> 26](addr, value);
}
void FASTCALL mmio_write_half(u32 addr, u32 value) {
	write_half_map[addr >> 26](addr, value);
}
void FASTCALL mmio_write_word(u32 addr, u32 value) {
